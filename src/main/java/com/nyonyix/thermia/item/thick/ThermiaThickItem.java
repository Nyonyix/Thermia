...
public class ThermiaThickItem extends Item implements ICurioItem
{
    private final ThermiaThickMaterial material;
    private final String slot;

    public ThermiaThickItem(ThermiaThickMaterial material, String slot, Properties properties)
    {
        super(properties);
