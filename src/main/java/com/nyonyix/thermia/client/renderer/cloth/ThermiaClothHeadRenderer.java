...
public class ThermiaClothHeadRenderer implements ICurioRenderer
{
    private final ThermiaClothWearableMaterial material;
    private HumanoidArmorModel<LivingEntity> armourModel;

    public ThermiaClothHeadRenderer(ThermiaClothWearableMaterial material)
    {
