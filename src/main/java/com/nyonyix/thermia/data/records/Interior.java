...
)
{
    ...
    public Interior withExternalHumidity(float externalHumidity) {return new Interior(this.interiorBlocks, this.internalAirBlocks, this.homePos, this.boundingBox, this.isValid, this.internalHumidity, externalHumidity, this.internalTemperature, this.externalTemperature, this.porosity, this.externalPull, this.sourcePull, this.volume);}
