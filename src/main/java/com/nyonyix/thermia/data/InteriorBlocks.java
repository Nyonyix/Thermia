...
public final class InteriorBlocks
{
    ...
    public static final Codec<InteriorBlocks> CODEC = SERIAL_CODEC.xmap(
            s -> new InteriorBlocks(s.edgeBlocks(), s.heatSourceBlocks(), s.heatSourceFluids(), s.heatSinkBlocks(), s.heatSinkFluids()),
            ib -> new SerialForm(ib.toLongMap(ib.edgeBlocks), ib.toLongMap(ib.heatSourceBlocks), ib.toFluidLongMap(ib.heatSourceFluids), ib.toLongMap(ib.heatSinkBlocks), ib.toFluidLongMap(ib.heatSinkFluids))
    );

    public InteriorBlocks(Map<BlockPos, Block> edgeBlocks, Map<BlockPos, Block> heatSourceBlocks,
    ...
    public InteriorBlocks(Long2ObjectOpenHashMap<Block> edgeBlocks, Long2ObjectOpenHashMap<Block> heatSourceBlocks,
    ...
    public static InteriorBlocks createDefault() {return new InteriorBlocks(new Long2ObjectOpenHashMap<>(), new Long2ObjectOpenHashMap<>(), new Long2ObjectOpenHashMap<>(), new Long2ObjectOpenHashMap<>(), new Long2ObjectOpenHashMap<>());}
