...
{
    private static boolean shouldReceiveSystem(Entity entity)
    {
        ...
        if (entity instanceof TFCAnimal tfcAnimal) return tfcAnimal.getFamiliarity() >= 10f;
    ...
    {
        EntityTemperature entityData = entity.getData(ThermiaAttachments.ENTITY_TEMPERATURE) != null ? entity.getData(ThermiaAttachments.ENTITY_TEMPERATURE) : EntityTemperature.createDefault().withMaxInternalTemperature(1.0f).withMinInternalTemperature(0.0f);
