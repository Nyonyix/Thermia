...
//    );
    ...
    public static BlockSearchResult createDefault() {return new BlockSearchResult(BlockPos.ZERO, 0.0, new HashMap<>(), new HashMap<>());}

    public BlockSearchResult withNearest(BlockPos nearest) {return new BlockSearchResult(nearest, this.nearestDistSq, this.counts, this.allPositions);}

    public BlockSearchResult withNearestDistSq(double nearestDistSq) {return new BlockSearchResult(this.nearest, nearestDistSq, this.counts, this.allPositions);}

    public BlockSearchResult withCounts(Map<Block, Integer> counts) {return new BlockSearchResult(this.nearest, this.nearestDistSq, counts, this.allPositions);}

    public BlockSearchResult withAllPositions(Map<Block, List<BlockPos>> allPositions) {return new BlockSearchResult(this.nearest, this.nearestDistSq, this.counts, allPositions);}
}