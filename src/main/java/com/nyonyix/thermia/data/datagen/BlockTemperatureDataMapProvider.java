...
public class BlockTemperatureDataMapProvider extends DataMapProvider
{
    ...
    protected void gather()
    {
        builder(ThermiaDataMaps.BLOCK_TEMPERATURE_DATA_MAP).replace(true)
                ...
                .add(BuiltInRegistries.BLOCK.getHolder(ResourceLocation.parse("tfc:burning_log_pile")).orElseThrow(), new BlockTemperatureDataMap(900f, 32, false, Map.of(), Map.of(), Map.of()), false)
                .add(BuiltInRegistries.BLOCK.getHolder(ResourceLocation.parse("tfc:bloomery")).orElseThrow(), new BlockTemperatureDataMap(1200f, 8, false, Map.of("lit", true), Map.of(), Map.of()), false)
                ...
                .add(BuiltInRegistries.BLOCK.getHolder(ResourceLocation.parse("tfc:stove")).orElseThrow(), new BlockTemperatureDataMap(0f, 16, true, Map.of(), Map.of(), Map.of()), false)
                .add(BuiltInRegistries.BLOCK.getHolder(ResourceLocation.parse("tfc:stove_pot")).orElseThrow(), new BlockTemperatureDataMap(0f, 16, true, Map.of(), Map.of(), Map.of()), false)
                .add(BuiltInRegistries.BLOCK.getHolder(ResourceLocation.parse("tfc:firebox")).orElseThrow(), new BlockTemperatureDataMap(0f, 16, true, Map.of(), Map.of(), Map.of()), false);
    }
