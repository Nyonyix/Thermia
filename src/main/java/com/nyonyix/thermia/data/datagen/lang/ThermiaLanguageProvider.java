...
public class ThermiaLanguageProvider extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        add("thermia.configuration.interiorSourceMulti", "Interior Source Multiplier");
        add("thermia.configuration.interiorSolarMulti", "Interior Solar Multiplier");
        ...
        add("tooltip.thermia.conduction", "Conduction: %1$f");
        add("tooltip.thermia.radiation", "Radiation: %1$f");
