...
public class ServerConfig
{
    ...
    public static final ModConfigSpec.DoubleValue TEMP_CHANGE_MAX_RATE = BUILDER.comment("Maximum rate for which entity internal temperature changes").defineInRange("tempChangeMaxRate", 0.01, 0.001, 0.5);
