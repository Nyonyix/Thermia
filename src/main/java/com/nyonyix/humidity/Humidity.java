...
public class Humidity {
    ...
    public static final String MODID = "humidity";
    ...
    public Humidity(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Humidity) to respond directly to events.
